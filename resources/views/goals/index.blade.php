    ...
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{ route('goals.search') }}" method="POST" class="row g-3">
                @csrf
                <div class="col-md-8">
                    <input type="text" name="search" class="form-control" placeholder="Buscar metas..."
                            ...
                            <div class="card h-100">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-start mb-3">
                                        ...
                                        @if($goal->category)
                                            <span class="badge" style="background-color: {{ $goal->category->color }}; color: white;">
                                                {{ $goal->category->name }}
                                            </span>
                                        @endif
                                        <span class="badge 
